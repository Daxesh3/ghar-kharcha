        ...
        <header className='bg-white border-b border-gray-200 sticky top-0 z-30'>
            <div className='px-4 md:px-6 py-3 flex items-center justify-between'>
                <div className='flex items-center'>
                    <button onClick={toggleSidebar} className='p-2 rounded-lg text-gray-600 hover:bg-gray-100 md:hidden' aria-label='Open sidebar'>
                        <Menu size={24} />
                    </button>
                    <h1 className='md:hidden text-lg'>Ghar Kharcha</h1>
                </div>
                    ...
                    <div className='ml-3 relative'>
                        <div className='flex items-center'>
                            <button className='flex items-center rounded-full focus:outline-none'>
                                ...
                                <span className='ml-2 text-sm font-medium text-gray-700 hidden md:block'>{currentUser?.displayName || 'User'}</span>
                            </button>
                        </div>
                    </div>
                </div>
