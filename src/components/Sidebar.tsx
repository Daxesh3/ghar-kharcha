    ...
    <div className={`flex flex-col h-full ${mobile ? 'w-64' : 'w-64'} bg-white border-r border-gray-200`}>
      {mobile && (
        <div className="flex items-center justify-between p-4 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-800">Family Finance</h2>
          <button 
            onClick={onClose}
      ...
      <div className={`p-3 ${mobile ? '' : 'pt-6'}`}>
        <div className={`${mobile ? 'hidden' : 'mb-8 mx-4'}`}>
          <h1 className="text-xl font-semibold text-gray-800">Family Finance</h1>
          <p className="text-sm text-gray-500 mt-1">Manage your household expenses</p>
        </div>
