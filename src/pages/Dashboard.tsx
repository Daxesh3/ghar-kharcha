                ...
                <div className='inline-flex rounded-lg border border-gray-200 bg-white'>
                    <button
                        ...
                        className={`px-4 py-2 text-sm font-medium rounded-l-lg ${
                            period === 'week' ? 'bg-primary-50 text-primary-700' : 'text-gray-600 hover:bg-gray-50'
                        }`}
                    >
                        Week
                    </button>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4'>
                ...
                <div className='card p-5'>
                    <div className='flex justify-between items-start'>
                        ...
                        <div
                            className={`${
                                budgetProgress < 75 ? 'bg-success-500/20' : budgetProgress < 90 ? 'bg-warning-500/20' : 'bg-error-500/20'
                            } p-2 rounded-lg`}
                        >
                            <Wallet
                                size={20}
                                className={`
                ${budgetProgress < 75 ? 'text-success-500' : budgetProgress < 90 ? 'text-warning-500' : 'text-error-500'}`}
                            />
                        </div>
                    </div>
                    <div className='mt-2'>
                        <div className='w-full bg-gray-200 rounded-full h-2'>
                            <div
                                className={`h-2 rounded-full ${
                                    budgetProgress < 75 ? 'bg-success-500' : budgetProgress < 90 ? 'bg-warning-500' : 'bg-error-500'
                                }`}
