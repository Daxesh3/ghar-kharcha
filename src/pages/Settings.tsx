        ...
        <div className='max-w-4xl mx-auto py-6'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
                ...
                <div className='md:col-span-2'>
                    {/* Profile Section */}
                    <div id='profile' className='card p-4 mb-6'>
                        <h2 className='text-xl font-semibold mb-4'>Profile Information</h2>

                        {successMessage && <div className='mb-4 p-3 bg-success-50 text-success-700 rounded-lg'>{successMessage}</div>}

                        {errorMessage && <div className='mb-4 p-3 bg-error-50 text-error-700 rounded-lg'>{errorMessage}</div>}
                        ...
                        <form onSubmit={handleProfileUpdate}>
                            ...
                            <div className='mb-4'>
                                ...
                                <input type='email' id='email' className='input-field bg-gray-50' value={currentUser?.email || ''} disabled />
                    ...
                    <div id='data' className='card p-4'>
                        <h2 className='text-xl font-semibold mb-4'>Data Management</h2>
                        <p className='text-gray-600 mb-4'>Manage your expense data by exporting or importing it</p>
